...
namespace PM.WebServices.Models
{
    ...
    public partial class SistemaTipoLog
    {
        /// <summary>
        /// Initializes a new instance of the SistemaTipoLog class.
        /// </summary>
        public SistemaTipoLog() { }

        /// <summary>
        /// Initializes a new instance of the SistemaTipoLog class.
        /// </summary>
        public SistemaTipoLog(int idTipoLog, string dsDescricao, DateTime dtOcorrencia, bool isAtivo, int idAplicacao, BaseModel baseModel = default(BaseModel))
        {
            IdTipoLog = idTipoLog;
