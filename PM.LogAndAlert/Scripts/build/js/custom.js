...
// /Sidebar
	...
	var randNum = function() { return (Math.floor(Math.random() * (1 + 40 - 20))) + 20; };
	...
	/* CROPPER */
	   ...
	   /* DATERANGEPICKER */
		...
		function init_daterangepicker() {
            ...
            $('#reportrange span').html(moment().subtract(29, 'days').format('DD/MM/YYYY') + ' até ' + moment().format('DD/MM/YYYY'));
			...
			$('#reportrange').on('cancel.daterangepicker', function(ev, picker) {
                ...
                alert('Botao Cancelar foi pressionado custom.js(1232)');
			});
	   ...
	   function init_daterangepicker_right() {
		...
		function init_daterangepicker_reservation() {
            ...
            $('.datapickerranger').daterangepicker(null, function(start, end, label) {
			  console.log(start.toISOString(), end.toISOString(), label);
			});
...
// Desabilitar funcionalidade do browser ^F5
function disableF5(e) {
	...
	$(document).ready(function() {
        ...
        $(".FullScreen").on('click', function () {
            /**********************************************************************************
            **
            ** Fonte de Dados: https://www.w3schools.com/howto/howto_js_fullscreen.asp
            **
            ***********************************************************************************/
            var elem = document.documentElement;
            if (document.getElementById('hddFullScreen').value == "0") {
                document.getElementById('hddFullScreen').value = "1";
                ...
                document.getElementById('hddFullScreen').value = "0";
