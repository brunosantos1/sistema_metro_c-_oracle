...
{
    public class RelatorioPrioritariosController : BaseController
    {
        public ActionResult Imprimir()
        {
            RelatorioPrioritarioViewModel telaVM = CarregarViewBags(new RelatorioPrioritarioViewModel());
            return View(telaVM);
        }
        ...
        public ActionResult Imprimir(RelatorioPrioritarioViewModel telaVM)
        {
        ...
        private RelatorioPrioritarioViewModel CarregarViewBags(RelatorioPrioritarioViewModel _telaVM)
        {
