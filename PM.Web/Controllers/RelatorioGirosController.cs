...
{
    public class RelatorioGirosController : BaseController
    {
        public ActionResult Imprimir()
        {
            RelatorioGiroViewModel telaVM = CarregarViewBags(new RelatorioGiroViewModel());
            return View(telaVM);
        }
        ...
        public ActionResult Imprimir(RelatorioGiroViewModel telaVM)
        {
        ...
        private RelatorioGiroViewModel CarregarViewBags(RelatorioGiroViewModel _telaVM)
        {
