...
{
    public class ApontarNOIsController : BaseController
    {
        public ActionResult Criar()
        {
            ApontarNOIViewModel telaVM = CarregarViewBags(new ApontarNOIViewModel());
            return View(telaVM);
        }
        ...
        public ActionResult Criar(ApontarNOIViewModel telaVM)
        {
        ...
        private ApontarNOIViewModel CarregarViewBags(ApontarNOIViewModel _telaVM)
        {
