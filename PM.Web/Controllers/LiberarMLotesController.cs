...
{
    public class LiberarMLotesController : BaseController
    {
        public ActionResult Liberar()
        {
            LiberarMLoteViewModel telaVM = CarregarViewBags(new LiberarMLoteViewModel());
            return View(telaVM);
        }
        ...
        public ActionResult Liberar(LiberarMLoteViewModel telaVM)
        {
        ...
        private LiberarMLoteViewModel CarregarViewBags(LiberarMLoteViewModel _telaVM)
        {
