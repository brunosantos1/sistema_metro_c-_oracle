...
{
    /// <summary>
    /// NotaPSs Controller responsavel pelas ações e trocas de dados de Front e Back.
    /// </summary>
    /// 
    [RoutePrefix("Oficina2")]
    public class NotaPSsController : BaseController
    {
        /// <summary>
        ...
        {
            NotaPSViewModel telaVM = new NotaPSViewModel();
            ...
            telaVM.SelecionarCentroTrabalho = centroTrabalhos.Select(d => new SelectListItem { Value = d.IdCentroFk.ToString(), Text = d.DsCtTrabalho }).ToList();
        ...
        public ActionResult Criar(NotaPSViewModel telaVM)
        {
