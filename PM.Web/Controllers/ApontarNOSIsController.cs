...
{
    public class ApontarNOSIsController : BaseController
    {
        public ActionResult Criar()
        {
            ApontarNOSIViewModel telaVM = CarregarViewBags(new ApontarNOSIViewModel());
            return View(telaVM);
        }
        ...
        public ActionResult Criar(ApontarNOSIViewModel telaVM)
        {
        ...
        private ApontarNOSIViewModel CarregarViewBags(ApontarNOSIViewModel _telaVM)
        {
