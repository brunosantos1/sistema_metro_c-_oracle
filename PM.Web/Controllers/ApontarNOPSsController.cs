...
{
    public class ApontarNOPSsController : BaseController
    {
        public ActionResult Criar()
        {
            ApontarNOPSViewModel telaVM = CarregarViewBags(new ApontarNOPSViewModel());
            return View(telaVM);
        }
        ...
        public ActionResult Criar(ApontarNOPSViewModel telaVM)
        {
        ...
        private ApontarNOPSViewModel CarregarViewBags(ApontarNOPSViewModel _telaVM)
        {
