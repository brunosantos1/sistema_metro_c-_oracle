...
namespace PM.ServiceSoap.Models
{
    ...
    public class MCNotaModel
    {
        ...
        //[MaxLength()]
        [DataMember(Name = "VIQMEL-QMCOD", EmitDefaultValue = false)]
        ...
        //[MaxLength()]
        [DataMember(Name = "VIQMEL-PRIOK", EmitDefaultValue = false)]
        ...
        public string InterferenciaOperacional { get; set; }
